...
ScrollReveal().reveal('.home .info h2,.home .info h1, .section-title-01, .section-title-02', { delay: 500, origin: 'left' });
...
ScrollReveal().reveal('.experience-card, .service-card, .education, .profolio .img-card', { delay: 800, origin: 'left', interval: 200 });
